...
(
	...
	is_deleted tinyint default '0' null,
	referencia_id int default '1' null,
	created_at timestamp null,
	updated_at timestamp null,
...
(
	...
	secDos int not null,
	opcion int not null,
	monto decimal(10,2) default '0.00' null
)
;
...
create procedure OP_Citas_add_all (IN XTITULO varchar(200), IN XFECHA date, IN XDESDE time, IN XHASTA time, IN XIDPACIENTE int, IN XIDDOCTOR int, IN XIDSEDE int)
BEGIN
...
create procedure OP_Citas_update_all (IN XID int, IN XTITULO varchar(200), IN XFECHA date, IN XDESDE time, IN XHASTA time, IN XIDPACIENTE int, IN XIDDOCTOR int, IN XIDSEDE int)
BEGIN
...
create procedure OP_Doctors_add_all (IN XNOMBRES varchar(90), IN XAPELLIDOS varchar(90), IN XDNI varchar(8), IN XEMAIL varchar(90), IN XDIRECCION varchar(90), IN XFECHA_NACIMIENTO date, IN XGENERO varchar(25), IN XESTADO varchar(25), IN XTELEFONO varchar(50), IN XCELULAR varchar(50), IN XCELULAR_AUX varchar(50), IN XMARGEN_GANANCIA decimal)
BEGIN
...
create procedure OP_Doctors_update_all_Id (IN XNOMBRES varchar(90), IN XAPELLIDOS varchar(90), IN XDNI varchar(8), IN XEMAIL varchar(90), IN XDIRECCION varchar(90), IN XFECHA_NACIMIENTO date, IN XGENERO varchar(25), IN XESTADO varchar(25), IN XTELEFONO varchar(50), IN XCELULAR varchar(50), IN XCELULAR_AUX varchar(50), IN XMARGEN_GANANCIA decimal, IN XID int)
BEGIN
...
create procedure OP_Egresos_add_all (IN XFECHA date, IN XCANTIDAD int, IN XCONCEPTO varchar(125), IN XTIPO varchar(125), IN XOBSERVACION varchar(125), IN XPRECIO_UNITARIO decimal(6,2), IN XSEDEID int)
BEGIN
...
create procedure OP_Egresos_add_all_doctor (IN XFECHA date, IN XCANTIDAD int, IN XCONCEPTO varchar(125), IN XTIPO varchar(125), IN XOBSERVACION varchar(125), IN XPRECIO_UNITARIO decimal(6,2), IN XSEDEID int, IN XDOCTOR_ID int)
BEGIN
...
create procedure OP_Egresos_update_all_Id (IN XFECHA date, IN XCANTIDAD int, IN XCONCEPTO varchar(125), IN XTIPO varchar(125), IN XOBSERVACION varchar(125), IN XPRECIO_UNITARIO decimal(6,2), IN XSEDEID int, IN XID int)
BEGIN
	UPDATE egresos
...
create procedure OP_Egresos_update_all_doctor_Id (IN XFECHA date, IN XCANTIDAD int, IN XCONCEPTO varchar(125), IN XTIPO varchar(125), IN XOBSERVACION varchar(125), IN XPRECIO_UNITARIO decimal(6,2), IN XDOCTOR_ID int, IN XSEDEID int, IN XID int)
BEGIN
	UPDATE egresos
    SET fecha = XFECHA, cantidad = XCANTIDAD, concepto = XCONCEPTO,
        tipo = XTIPO, observacion = XOBSERVACION, precio_unitario = XPRECIO_UNITARIO,
...
create procedure OP_Ingresos_Detalle_add_all (IN XID_INGRESO int, IN XID_PRECIO int, IN XCANTIDAD int, IN XMONTO decimal(11,2), IN XFECHA date, IN XSEDEID int, IN XDOCTOR int)
BEGIN
...
create procedure OP_Ingresos_get_ingresos_por_doctor_doctor_id_fechas (IN doctor_id int, IN start_date date, IN end_date date)
BEGIN
	IF doctor_id = 0 THEN
...
create procedure OP_Pacientes_add_all (IN XNOMBRES varchar(90), IN XAPELLIDOS varchar(90), IN XDNI varchar(8), IN XEMAIL varchar(90), IN XDIRECCION varchar(90), IN XFECHA_NACIMIENTO date, IN XGENERO varchar(25), IN XESTADO varchar(25), IN XTELEFONO varchar(50), IN XFAX varchar(50), IN XCELULAR varchar(50), IN XCELULAR_AUX varchar(50), IN XID_EMPRESA int, IN XID_SEGURO_IND int, IN XNOMBRE_APODERADO varchar(150), IN XCELULAR_APODERADO varchar(150), IN XREFERENCIA_ID int, IN XSEDE_ID int)
BEGIN
...
create procedure OP_Pacientes_get_pacientes_creados_por_mes_fechas (IN start_date date, IN end_date date, IN xsede_id int)
BEGIN
	SET lc_time_names = 'es_ES';
...
create procedure OP_Pacientes_update_all_Id (IN XNOMBRES varchar(90), IN XAPELLIDOS varchar(90), IN XDNI varchar(8), IN XEMAIL varchar(90), IN XDIRECCION varchar(90), IN XFECHA_NACIMIENTO date, IN XGENERO varchar(25), IN XESTADO varchar(25), IN XTELEFONO varchar(50), IN XFAX varchar(50), IN XCELULAR varchar(50), IN XCELULAR_AUX varchar(50), IN XID_EMPRESA int, IN XID_SEGURO_IND int, IN XNOMBRE_APODERADO varchar(150), IN XCELULAR_APODERADO varchar(150), IN XREFERENCIA_ID int, IN XSEDE_ID int, IN XID int)
BEGIN
...
create procedure OP_Presupuesto_Detalles_add_all (IN XID_PRESUPUESTO int, IN XPIEZA int, IN XSECCION int, IN XSECUNO int, IN XSECDOS int, IN XOPCION int, IN XMONTO decimal(10,2))
BEGIN
...
create procedure OP_Sedes_add_all (IN XNOMBRE varchar(150), IN XCIUDAD varchar(150), IN XDIRECCION varchar(100), IN XTELEFONO varchar(200), IN XCELULAR varchar(200), IN XCELAUX varchar(200), IN XEMAIL varchar(200))
BEGIN
...
create procedure OP_Sedes_update_all_Id (IN XID int, IN XNOMBRE varchar(150), IN XCIUDAD varchar(150), IN XDIRECCION varchar(100), IN XTELEFONO varchar(200), IN XCELULAR varchar(200), IN XCELAUX varchar(200), IN XEMAIL varchar(200))
BEGIN
...
create procedure OP_Tratamientos_get_tratamientos_por_doctor_fechas (IN start_date date, IN end_date date, IN xsede_id int)
BEGIN
	SET lc_time_names = 'es_ES';
