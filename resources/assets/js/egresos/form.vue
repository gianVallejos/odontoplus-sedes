					...
					axios(request).then((response) => {
						...
						if(response.data.success){							
							...
							if( response.data.success == 'created' ){							
								self.setDisableForm()
								self.toastFunctionRedirect('Éxito', 'El egreso ha sido creado correctamente. <br />Redireccionando...', 'success')
								...
								self.toastFunctionRedirect('Éxito', 'El egreso ha sido eliminado correctamente. <br />Redireccionando...', 'success')
							}
