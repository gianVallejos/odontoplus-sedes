<template>
  <b-container>
      ...
      <div class="col-md-12">
        <PanelCard>
          <span slot="heading">Lista de Proveedores & Laboratorios</span>
            ...
            <b-row class="pb-3">
							...
							<div class="col-md-6">							
								<div class="float-right d-inline-block">
									<b-button-group>										
										<b-button :href="url+'/proveedores/create'" variant="success">
											<i class="fas fa-plus"></i>&nbsp; Nuevo Proveedor/Laboratorio
										</b-button>
  ...
  export default{
    ...
    data(){
        ...
        fields: [
          ...
          { key: 'tipo_id', label: 'Tipo', sortable: true }
          ],
        currentPage: 1,
        perPage: 10,
        ...
        breadcrumb: [
          { text: 'Home', href: '/' },
          { text: 'Lista de Proveedores/Laboratorios', active: true }
        ]
			}
		},
    computed: {
