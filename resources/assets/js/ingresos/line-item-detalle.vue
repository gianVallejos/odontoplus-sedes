		...
		data(){
			return{
				fields: [
						...
						{ key: 'codigo', label: 'Código', sortable: true, sortDirection: 'desc', 'class': 'text-center' },
						{ key: 'tipo_pago_nombre', label: 'Pago', sortable: true, sortDirection: 'desc', 'class': 'text-center' },
						{ key: 'nombre_sede', label: 'Sede', sortable: true, sortDirection: 'desc', 'class': 'text-center' },
