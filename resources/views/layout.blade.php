...
<head>
	...
	<link rel="stylesheet" href="{{ asset('css/odontoplus.css?v=1.0.44') }}">
	<link rel="stylesheet" href="{{ asset('css/header.css?v=1.0.7') }}">
	<link rel="stylesheet" href="{{ asset('css/dashboard.css?v=1.0.1') }}">
	<link rel="stylesheet" href="{{ asset('css/auth.css?v=1.0.1') }}" />
