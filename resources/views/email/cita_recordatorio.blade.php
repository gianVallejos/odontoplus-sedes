<?php
    $url = 'https://app.odontoplus.pe/images/logotipos/' . $schema . '_BG_WHITE.png';
...
<div>
    <div style="padding: 25px 0; text-align: center; background-color: #f3f3f3;">
        <img src="<?php echo $url; ?>" alt="{{ $cliente->nombre_comercial }}" onerror="<?php echo $error_url; ?>">
    </div>
    <div style="text-align: center; margin-top: 45px; margin-bottom: 45px;">
      <div style="display: inline-block; width: 570px;">
        ...
        <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
          ...
          <br />Te esperamos en {{ $cliente->nombre_comercial }} ubicando en {{ $cliente->direccion }}.
      </div>
    </div>
